...
<div class="main-panel">
  <div class="content-wrapper">
    ...
    <div class="card shadow-sm">
      <div class="card-body">
        <h4 class="card-title mb-4"><i class="mdi mdi-account-circle"></i> Profil Saya</h4>
        ...
        <div class="row">
          <div class="col-md-4 text-center">
            ...
            ?>
            <img src="<?= htmlspecialchars($foto_path); ?>" alt="Profile" class="img-fluid rounded-circle mb-3"
          ...
          <div class="col-md-8">
            ...
            <div class="mt-4">
              ...
              <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#ubahPasswordModal">
